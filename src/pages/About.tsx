  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-4 text-center">Salon Özelliklerimiz</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Salon Kapasiteleri</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Gelin Odaları</h3>
                  <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Bahçe Alanı</h3>
                  <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Çocuk Dostu</h3>
                  <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Otopark</h3>
                  <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-800 mb-2">Konum</h3>
                  <p className="text-gray-600 leading-relaxed">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-4 text-center">Vizyonumuz ve Misyonumuz</h2>
          <div className="w-24 h-1 bg-[#D4AF37] mx-auto mb-12"></div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-[#D4AF37] to-[#B8860B] text-white rounded-2xl p-8 shadow-xl">
            ...
            <div className="bg-white border-2 border-[#D4AF37] rounded-2xl p-8 shadow-xl">
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-800 mb-4 text-center">Değerlerimiz</h2>
          <div className="w-24 h-1 bg-[#D4AF37] mx-auto mb-12"></div>
