    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="relative h-[300px] bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">Rezervasyon</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-6 md:p-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 sm:mb-8">Teklif Formu</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                <div className="grid md:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent outline-none transition-all touch-manipulation"
                      ...
                      <label
                        ...
                        className={`flex items-start p-3 sm:p-4 border-2 rounded-lg cursor-pointer transition-all touch-manipulation min-h-[60px] ${
                          formData.package === pkg.value
                            ...
                            : 'border-gray-300 hover:border-[#D4AF37]/50 active:border-[#D4AF37]/30'
                        }`}
                      >
                        <input
                          type="radio"
                        ...
                        <div className="ml-2 sm:ml-3">
                          <div className="font-semibold text-gray-800 text-sm sm:text-base">{pkg.label}</div>
                          <div className="text-xs sm:text-sm text-gray-600">{pkg.desc}</div>
                        </div>
                      </label>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent outline-none transition-all resize-none touch-manipulation"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#D4AF37] to-[#B8860B] text-white py-3 sm:py-3.5 md:py-4 rounded-lg text-base sm:text-lg font-semibold hover:from-[#B8860B] hover:to-[#D4AF37] active:from-[#A67A0A] active:to-[#B8860B] transition-all shadow-lg hover:shadow-xl active:shadow-md transform active:scale-[0.98] hover:scale-[1.02] flex items-center justify-center space-x-2 touch-manipulation min-h-[52px]"
                >
          ...
          <div className="space-y-4 sm:space-y-5 md:space-y-6">
            <div className="bg-gradient-to-br from-[#D4AF37] to-[#B8860B] rounded-2xl shadow-xl p-4 sm:p-5 md:p-6 text-white">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-5 md:p-6">
              <div className="flex items-start space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2 sm:mb-3">Rezervasyon Koşulları</h3>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-5 md:p-6">
              <div className="flex items-start space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Sık Sorulan Sorular</h3>
                  <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm">
                    <div>
                      <p className="font-semibold text-gray-800 mb-1">Rezervasyon için ne kadar önceden başvurmalıyım?</p>
                      <p className="text-gray-600">Özellikle yaz ve bahar ayları için en az 6 ay önceden rezervasyon yapmanızı öneririz.</p>
                    </div>
                    <div>
                      <p className="font-semibold text-gray-800 mb-1">Kendi ikramlarımızı getirebilir miyiz?</p>
                      <p className="text-gray-600">Düğün pastası hariç dışarıdan ikram getirilmesine izin verilmemektedir.</p>
                    </div>
                    <div>
                      <p className="font-semibold text-gray-800 mb-1">Minimum ve maksimum misafir sayınız nedir?</p>
                      <p className="text-gray-600">Minimum 50, maksimum 900 kişi ağırlayabiliyoruz. Alt kat büyük salonda 700, üst kat küçük salonda 200 kişi kapasitemiz bulunmaktadır.</p>
                    </div>
                  </div>
                </div>
              </div>
