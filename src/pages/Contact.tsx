    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="relative h-[300px] bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">İletişim</h1>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-8 sm:py-12 md:py-16">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 sm:mb-8">Bize Ulaşın</h2>

            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start space-x-3 sm:space-x-4 p-4 sm:p-5 md:p-6 bg-white rounded-xl shadow-lg hover:shadow-xl active:shadow-md transition-shadow">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-1.5 sm:mb-2">Telefon</h3>
                  <a
                    href="tel:+905414513806"
                    className="text-gray-600 hover:text-[#D4AF37] active:text-[#B8860B] transition-colors text-sm sm:text-base touch-manipulation min-h-[44px] flex items-center"
                  >
                    +90 541 451 38 06
                  </a>
                </div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 p-4 sm:p-5 md:p-6 bg-white rounded-xl shadow-lg hover:shadow-xl active:shadow-md transition-shadow">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-1.5 sm:mb-2">Çalışma Saatleri</h3>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 p-4 sm:p-5 md:p-6 bg-white rounded-xl shadow-lg hover:shadow-xl active:shadow-md transition-shadow">
                ...
                <div className="flex-1">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3">Sosyal Medya</h3>
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                    <a
                      href="https://www.facebook.com/cetinkonaksalon/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-gradient-to-br from-[#D4AF37] to-[#B8860B] hover:from-[#B8860B] hover:to-[#D4AF37] active:from-[#A67A0A] active:to-[#B8860B] text-white px-4 sm:px-5 py-2.5 rounded-lg text-sm sm:text-base font-semibold transition-all shadow-md hover:shadow-lg active:shadow-sm transform active:scale-95 hover:scale-105 flex items-center justify-center space-x-2 touch-manipulation min-h-[44px]"
                    >
            ...
            <div className="mt-6 sm:mt-8 p-6 sm:p-7 md:p-8 bg-gradient-to-br from-[#D4AF37] to-[#B8860B] rounded-2xl shadow-xl text-center">
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 sm:mb-8">Konum</h2>
            ...
            <button
              ...
              className="w-full mt-3 sm:mt-4 bg-[#D4AF37] text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg text-sm sm:text-base font-semibold hover:bg-[#B8860B] active:bg-[#A67A0A] transition-all shadow-md hover:shadow-lg active:shadow-sm flex items-center justify-center space-x-2 touch-manipulation min-h-[48px]"
            >
